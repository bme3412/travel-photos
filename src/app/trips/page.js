  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12 sm:py-16">
      <header className="max-w-2xl">
        <p className="text-[11px] uppercase tracking-[0.3em] text-accent mb-3">Retrace the journeys</p>
        <h1 className="font-display text-4xl sm:text-5xl tracking-tight">Trip Replays</h1>
        <p className="mt-4 text-ink/70 leading-relaxed">
          Every trip, replayed. Press into any journey to retrace its route and photographs, stop by
          stop.
        </p>
